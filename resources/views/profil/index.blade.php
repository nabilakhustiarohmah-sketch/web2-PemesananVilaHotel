  ...
  <div style="background:white; border-radius:20px; border:1px solid #e2e8f0; width:100%; max-width:460px; overflow:hidden;">
    ...
    <div style="padding:1.5rem;">
      <div style="display:flex; align-items:center; gap:12px; padding:12px 0; border-bottom:1px solid #f1f5f9;">
        <div style="width:36px; height:36px; border-radius:10px; background:#eff6ff; display:flex; align-items:center; justify-content:center; color:#2563eb; font-size:16px; flex-shrink:0;">
          &#128100;
        </div>
        <div>
    ...
    <div style="padding:0 1.5rem 1.5rem; display:flex; gap:10px;">
      <a href="/" style="flex:1; text-align:center; padding:10px; border-radius:10px; border:1px solid #e2e8f0; font-size:13px; color:#475569; text-decoration:none; font-weight:500;">
        &#8592; Beranda
      </a>
      <form method="POST" action="{{ route('logout') }}" style="flex:1;">
        @csrf
        <button type="submit" style="width:100%; padding:10px; border-radius:10px; border:1px solid #fca5a5; background:white; color:#dc2626; font-size:13px; font-weight:500; cursor:pointer;">
          Logout
        </button>
      </form>
    </div>
